...
while sensor and sensor > 0:
    ...
    try:
        ...
        np.save('Filtered/PeMSD4/remaining_sensors', sensors)
        np.save('Filtered/PeMSD4/removed_sensors', removed_sensors)

np.save('Filtered/PeMSD4/sensors_to_keep', sensors[:, 0])
np.save('Filtered/PeMSD4/removed_sensors', removed_sensors)
print(len(sensors))
